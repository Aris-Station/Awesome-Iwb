...
### <img src="https://raw.githubusercontent.com/typed-sigterm/ex-caller/refs/heads/main/public/logo.webp"  height="28"/> ExCaller
...
简约风格的随机点名工具，使用 Vue 开发。支持彩带效果、自定义过号时间、设置多个名单并随时切换、名单批量导入导出、自定义背景图、点名计划。
